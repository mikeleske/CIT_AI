...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    # Lab10 exercise
    elif task_env == 'CartPoleStayUp-v1':
        register(
            id=task_env,
            entry_point='openai_ros.task_envs.cartpole_stay_up.stay_up_v1:CartPoleStayUpEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.cartpole_stay_up import stay_up_v1
